...
function s:WinClosedResizeCol(w, n, h)
	for i in reverse(range(a:n))
		call win_move_statusline(win_id2win(a:w) + i, a:h)
	endfor
endfunc
...
function s:WinClosed()
	...
	call timer_start(0, {_ -> s:WinClosedResizeCol(col[0], n, h)})
endfunc
